...
export const delete_tool_interaction = async (
  llm_interaction_id: number,
  tool_call_id: string
): Promise<void> => {
  await invoke("delete_tool_interaction", {
    llmInteractionId: llm_interaction_id,
    toolCallId: tool_call_id,
  });
};

export const chat = async (content: MessageContent): Promise<void> => {
